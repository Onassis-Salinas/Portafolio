<script>
    ...
    const projectSections = [
        ...
        {
            title: ["Automatizacion", "Automatization"],
            projects: [
                { title: ["Impresora de etiquetas", "Ticket Printer"], image: "", index: 0 },
                { title: ["Impresora de credenciales", "Credentials Printer"], image: "", index: 0 },
            ],
        },
        {
